...
class _UploadScreenState extends State<UploadScreen> with SingleTickerProviderStateMixin {
  ...
  final Map<String, Color> _resultColors = {
    'benign': const Color(0xFF4CAF50),      // Green
    'malignant': const Color(0xFFF44336),   // Red
    'normal': const Color(0xFF2196F3),      // Blue
    'pre-malignant': const Color(0xFFFF9800) // Orange
  };
  
  // Default color if prediction doesn't match any of the above
  static const Color _defaultResultColor = Color(0xFF2196F3); // Blue
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...individualPredictions.map((model) => _buildModelPredictionCard(model)),
        ],
      ),
    );
  }
