...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  final List<String> _filterOptions = ["All", "Benign", "Adenocarcinoma", "Squamous cell carcinoma"];
  
  // Result colors based on prediction
  final Map<String, Color> _resultColors = {
    'benign': const Color(0xFF4CAF50),      // Green
    'adenocarcinoma': const Color(0xFFE3A915),   // Red
    'squamous cell carcinoma': const Color(0xFF2196F3)// Blue
  };
