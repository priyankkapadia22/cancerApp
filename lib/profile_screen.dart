...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _reauthenticate() async {
    ...
    if (_isGoogleUser) {
      // ✅ Reauthenticate Google user with new API
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0, // Makes the transition to the blue container seamless
          leading: IconButton(
  ...
  Widget _buildProfileForm() {
    return SingleChildScrollView(
      child: Form(
        key: _formKey,
        child: Column(
          // 🔴 FIX: This ensures children stretch to the full width of the screen
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            // Profile header with avatar
            Container(
              width: double.infinity, // 🔴 FIX: Explicitly set full width
